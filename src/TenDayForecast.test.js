...
describe("TenDayForecast", () => {
  ...
  beforeEach(() => {
    shallowWrapper = shallow(<TenDayForecast tenDayForecast={tenDayData} />);

    mountWrapper = mount(<TenDayForecast tenDayForecast={tenDayData} />);
  });
